...
document
  ...
  .addEventListener("click", function () {
    ...
    // const Name1geometry =  new THREE.PlaneGeometry(1);

    // const Name1material = new THREE.MeshBasicMaterial({

    //     map: THREE.ImageUtils.loadTexture('texture/1.png'),
       
    // });

    // const Name1mesh = new THREE.Mesh(Name1geometry,Name1material);
    // Name1mesh.position.x = -0.6;
    // Name1mesh.position.y = 0.09;
    // scene.add(Name1mesh);
...
function tags(){
  document.getElementById("tag").className = "tagssnew";
}
